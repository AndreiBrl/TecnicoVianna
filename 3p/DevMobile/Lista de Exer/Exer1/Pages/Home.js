...
const Home = ({ navigation }) => {
    ...
    const checaCampos = () => {
        ...
        if (tipoCarro != "" && potenciaEcolhida != "") {
            ...
            navigation.navigate('Informacoes', {
                potenciaEcolhida: potenciaEcolhida, itensAdicionais: itensAdicionais, tipoCarro: tipoCarro
            })
            setItensAdicionais("");
            setPotencia("");
            setTipoCarro("");
    ...
    return (
        ...
        <View style={{ alignItems: 'center' }}>
            ...
            <Text style={{ backgroundColor: "gray", fontSize: 30, padding: 10, justifyContent: "center", borderRadius: 10, marginTop: 20 }}
